...
| **[SqlKit](https://www.geekfun.club/products/sqlkit/)** | Open-source AI-powered SQL client for 40+ databases — PostgreSQL, MySQL, SQL Server, Oracle, SQLite, DuckDB, ClickHouse, Snowflake, BigQuery, and more. Agentic Data Studio for natural language SQL. |
