...
## [Installation Guide](/products/dockit/docs/installation.md)

Thanks for trying out DocKit! :rocket::rocket::rocket: This guide will help you get started with DocKit.

## [Connect to Server](/products/dockit/docs/connect-to-server.md)
...
## [Shortcuts Introduction](/products/dockit/docs/shortcut.md)
...
## [Manage Elasticsearch Cluster](/products/dockit/docs/manage-elasticsearch-cluster.md)
