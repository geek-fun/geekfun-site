...
## [Announcing Data Studio MCP — Your AI coding agent can now talk to your databases](/blog/announcing-data-studio-mcp)
*August 7, 2026*

Data Studio MCP is an open-source MCP server that connects Claude Code, Cursor, Windsurf, OpenCode, and Codex to your databases through DocKit and SqlKit. Ask in plain language, get read-safe answers, and set it up in under 5 minutes.
