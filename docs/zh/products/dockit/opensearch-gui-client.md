...
**凭据存储在哪里？**
存储在您的本地设备上，不会传输到任何地方。

---

→ **[DocKit 完整功能概览](/zh/products/dockit/)** · [OpenSearch GUI 深度解析](/zh/products/dockit/opensearch-gui-client) · [Elasticsearch AI 助手](/zh/products/dockit/elasticsearch-gui-client)
