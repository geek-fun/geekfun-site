...
# SqlKit - 覆盖所有 SQL 数据库的 AI 智能体 SQL 桌面客户端
...
| **开源** | Apache 2.0 | GPL | ❌ | ❌ |
| **价格** | 社区版免费 · 旗舰版 $9.9/月 | 免费 | $199/年 | $199+ |
...
属于付费旗舰版订阅。用云端模型（OpenAI、Anthropic 等）你还要付 LLM 的调用费；本地模型走 Ollama 或 LM Studio 则没有 LLM 费用。
