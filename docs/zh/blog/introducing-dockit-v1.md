...
**2026 年 3–4 月。** v0.9.x 冲刺。8 周内 10 个补丁版本：Elasticsearch API Key 认证、连接克隆、查询参数自动补全、连接排序筛选、历史视图键盘导航、DynamoDB SSO 和 AssumeRole、完全重建的 Data Studio Data AI Agent（流式 LLM 响应），以及 Naive UI → shadcn-vue 迁移的完成。0.9 系列共 20 个版本。
