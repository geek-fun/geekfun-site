...
- **Products index:** single row of six icon-above-name items (64px icons, centered), separated by vertical 1px hairlines — no card backgrounds, no descriptions; 6 → 3 columns at ≤1024px → 2 at ≤640px; hover lifts the icon and tints the name forge amber
